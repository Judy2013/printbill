...
function PrintInvoice(cData, pData){
	this.pData = pData;
	this.cart = {};
	this.save = 0;
	this.toPay = 0;
...
PrintInvoice.prototype.printProduct = function(){
...
PrintInvoice.prototype.printPromotion = function(){
...
PrintInvoice.prototype.printSumary = function(){
	console.log("-------------------------");
...
PrintInvoice.prototype.printAll = function(){
	this.printProduct();
	this.printPromotion();
	this.printSumary();
}